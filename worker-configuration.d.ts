/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f4752fbbec732dd4f7a75cf7a9ea3f7)
// Runtime types generated with workerd@1.20260918.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	CLASSIFIER_ORIGIN: "https://classifier.dev";
	ALLOW_LOCAL_DEV: "false";
	LABS_ROUTER_TOKEN: string;
	PRIVACY_SALT: string;
	DEMO_SESSIONS: DurableObjectNamespace<import("./src/worker").DemoSession>;
	RATE_GATES: DurableObjectNamespace<import("./src/worker").RateGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "DemoSession" | "RateGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLASSIFIER_ORIGIN" | "ALLOW_LOCAL_DEV" | "LABS_ROUTER_TOKEN" | "PRIVACY_SALT">> {}
}
